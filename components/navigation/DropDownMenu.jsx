...
const DropdownMenu = ({ category, isVisible, onMouseEnter, onMouseLeave }) => {
  ...
  return (
    <div
      className={`hidden absolute top-[270px]  transform -translate-x-1/2 bg-white shadow-lg rounded-lg 2xl:w-[1200px] xl:w-[1200px] lg:w-[1000px]  p-10 z-50 2xl:flex xl:flex lg:flex justify-center space-x-6 border border-gray-200 ${animationClass}`}
