          ...
          <div key={article.id} className="flex flex-col ">
            ...
            <div className="mt-2">
              ...
              <Link href={`/artikel/${article.id}/${article.slug}`}>
                <h4 className="text-md font-semibold hover:underline cursor-pointer mt-2">{article.title}</h4>
              </Link>
              <div className="flex items-center text-sm text-gray-500 mt-2">
                <Image src={author?.photo || "/default-avatar.png"} alt={author?.name} width={20} height={20} className="rounded-full" />
