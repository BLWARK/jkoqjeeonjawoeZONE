...
const LatestNews = ({ platformId: propPlatformId }) => {
  ...
  return (
    <div className="w-full flex 2xl:flex-row xl:flex-row lg:flex-row flex-col gap-10 2xl:max-w-[1200px] xl:max-w-[1200px] lg:max-w-[1020px] mx-auto py-8 ">
            ...
            {articles.map((article, index) => {
              ...
              return (
                ...
                >
                  ...
                  <Link href={`/artikel/${article.article_id}/${article.slug}`} passHref>
                    <div className="relative 2xl:w-[280px] xl:w-[280px] lg:w-[280px] w-[390px] h-[200px] rounded-lg overflow-hidden">
                      <Image
