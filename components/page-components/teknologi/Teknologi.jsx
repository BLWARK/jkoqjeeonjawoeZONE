...
const Teknologi = () => {
  ...
  return (
    ...
    <div className="w-full 2xl:max-w-[1200px] xl:max-w-[1200px] lg:max-w-[1020px] mx-auto py-20 2xl:px-0 xl:px-0 lg:px-0 px-3">
      <div className="flex w-full justify-between items-center">
        <div className="">
      <h2 className="text-3xl font-bold text-white flex items-center mb-3 ">Technologi</h2>
