export const metadata = {
  ...
  openGraph: {
    ...
    description:
      "Kenali visi dan misi XYZONEMEDIA dalam membangun platform digital yang menginspirasi dan memberdayakan generasi X, Y, dan Z.",
    url: "https://xyzone.media/visi-misi",
    siteName: "XYZONEMEDIA",
    images: [
      {
        url: "https://xyzone.media/images/og-visimisi.jpg", // ganti dengan OG image visimisi lo
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://xyzone.media/images/og-visimisi.jpg"],
  },
};
