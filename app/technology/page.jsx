...
const TechnologyPage = () => {
  // 🔹 Ambil berita utama (1 berita pertama) & 3 berita di sebelah kanan
  const mainArticle = teknologiData[0];
  const rightSideArticles = teknologiData.slice(1, 4);
  ...
  return (
    <div className="w-full 2xl:max-w-[1200px] xl:max-w-[1200px] lg:max-w-[1020px] mx-auto py-5 2xl:px-0 px-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        {/* 🔹 KANAN - 3 Berita (1 panjang di atas, 2 kotak di bawah) */}
